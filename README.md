...
- 评分口径、未查证项和资料边界说明
- 资料来源列表
- HTML 版本会自动增强摘要卡片、评分热力表、竞品能力雷达图、定位四象限、综合评分排行、结构化任务路径、来源卡片和优先级看板。
...
- 没有来源的功能、价格、数据和日期不能写成确定事实；报告应标记为“未查证”“待验证”或“不确定”。
- 评分矩阵、雷达图、四象限和排行属于分析模型输出，应写清评分口径，不能当成客观事实本身。
## License
MIT
